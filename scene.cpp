...
void Scene::load( void ) {
	...
	//LEFT
	primitives_.push_back( Primitive::PrimitiveUniquePtr( new Triangle{ glm::vec3{-2.0f, -2.0f, -3.0f},
	...
	primitives_.push_back( Primitive::PrimitiveUniquePtr( new Triangle{ glm::vec3{ 1.0f,  2.0f,  1.0f},
